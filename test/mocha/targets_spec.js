        ...
        describe('methods', () => {
            ...
            describe('findTargets', () => {
                it('should output nested arrays', () => {
                    ...
                    expect(res[0]).to.be.an('array').with.length.above(1)
                    expect(res[0][0]).to.be.a('string')
                    expect(res[0][1]).to.be.an('array').that.is.not.empty
                    expect(res[0][1][0]).to.be.a('string')
                })
